...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Кеш: " + fraction1.getRealValue());

        Fraction fraction2 = new Fraction<>(-1, 2);
        System.out.println("Вторая дробь: " + fraction2);

        System.out.println("Сравнение: " + fraction1.equals(fraction2)); // Вывод: true

        fraction1.setNumerator(3);
        fraction1.setDenominator(4);
        System.out.println("Первой дроби переприсвоили значение: " + fraction1); // Вывод: 3/4
        System.out.println("Кеш: " + fraction1.getRealValue()); // Вывод: 0.75

        // ЗАДАЧА 2.1
        System.out.println("\nЗадача 2.1 Количество мяуканий \n ");

        Cat cat = new Cat("Барсик"); // Создаём кота
